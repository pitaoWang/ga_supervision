...
@Entity
@Data
@Table(name = "skilled_check_record")
public class SkilledCheckRecord {
	/** 熟练检查记录id */
	@Id
	...
	public Long pilotId;
	/** 熟练检查记录标单号*/
	@ApiModelProperty(value="检查记录标单号")
	...
	/** 定期检查设备类型*/
	@ApiModelProperty(value="定期检查设备类型")
	...
	/** 熟练检查工作实践单*/
	@ApiModelProperty(value="检查工作实践单")
