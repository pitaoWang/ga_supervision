/** 
 * Project Name:ga-company-database 
 * File Name:SimulatorVO.java 
 * Package Name:com.atosenet.ga.company.db.model.ga.company.vo 
 * Date:2018年8月24日上午10:41:23 
...
/** 
* ClassName: SimulatorVO <br/> 
* Function: TODO ADD FUNCTION. <br/> 
* Reason: TODO ADD REASON(可选). <br/> 
* date: 2018年8月24日 上午10:41:23 <br/> 
* 
...
public class SimulatorVO implements ExcelData{
	/**
	 * id
	 */
	@Id
	...
	public String[] getFieldTitles() {
		...
		return new String[]{"所属企业","设备名称","合格证编号",
				"合格证有效期","设备型号","设备类型","生产序列号","等级","设备安装地点","设备制造厂家",
				"设备制作日期","初始鉴定日期","视景系统制造厂家","视景系统显示类型","视景系统型号","运动系统型号","运动系统制造厂家",
				"运动系统自由度","附加设备和功能","模拟航空器型号","空气动力数据修订号","空气动力数据出处","飞行操纵数据修订号",
				"飞行操纵数据出处","飞行管理系统标识","飞行管理系统修订版本","飞行模拟设备计算机标识","训练附加要求","鉴定测试指南",
				"模拟航空器制造厂家","使用声明","运行总时间","设备状态"};
	}
	...
	public String[] getFieldNames() {
		// TODO Auto-generated method stub
		return new String[]{"companyName","equipmentName",
				...
				"aircraftModel","airAmendmentNumber","airDataSource",
