...
import { getRequest, postRequest, putRequest,getRequests,postRequests, deleteRequest, uploadFileRequest } from '@/libs/axios';
...
// 个人中心修改密码
export const changePasss = (params) => {
    return postRequests('/AuthenticationManager/user/password/change', params)
}
// 解锁
...
export const getUser = (loginId,params) => {
    return getRequests(`/AuthenticationManager/user/exists/${loginId}` , params)
}
...
export const addUsers = (params) => {
    ...
    return postRequests(`/AuthenticationManager/user/add`, params)
}

export const delectUser = (employeeId,params) => {
    return getRequests(`/AuthenticationManager/user/delete/${employeeId}` , params)
}
// 启用用户
export const enableUsers = (employeeId, params) => {
    return getRequests(`/AuthenticationManager/user/enable/${employeeId}`, params)
}
// 禁用用户
export const disableUsers = (employeeId, params) => {
    return getRequests(`/AuthenticationManager/user/disable/${employeeId}`, params)
}
// 编辑用户
...
// 获取一级部门
export const initDepartment = (id, params) => {
...
export const findByParentId = (id, params) => {
    return getRequest(`/department/findByParentId/${id}`, params)
}
// 添加部门
