    ...
    <div style="width: 1280px; height: auto; background:white">
        <div style="">
            ...
            <div class="bottom5" style="width: 1260px; margin-left: 10px">
                <Table  :columns="columns7" :data="formValidate.awardRecords" @on-row-dblclick="info"></Table>

            </div>
        </div>

        <Modal v-model="modal1" title="奖惩记录" width="350px" @on-ok="dealcancel" @on-cancel="dealcancel" :styles="{top: '20px'}">
    ...
    export default {
        ...
        methods: {
            ...
            init: function (id) {
                ...
                self.$http.httpGet('/eim/api/award/search/'+self.employeeId, {
            ...
            info(obj){
                ...
                this.awardRecord = obj;
                this.modal1 = true;*/
                this.$router.push({path:'/viewAwardDetail',query: {obj:JSON.stringify(obj),employeeId:this.employeeId,employeeData:JSON.stringify(this.employeeData)}})
            },
            //修改框
            updateCheck(index) {
