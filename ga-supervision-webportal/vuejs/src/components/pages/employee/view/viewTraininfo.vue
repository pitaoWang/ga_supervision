    ...
    <div style="width: 1280px; height: auto; background:white">
        <div style="">
            ...
            <div class="bottom5" style="width: 1260px; margin-left: 10px">
                <Table  :columns="columns7" :data="formValidate.trainingRecords" @on-row-dblclick="info"></Table>
            </div>
        </div>

        <Modal v-model="modal1" title="培训信息" width="700px"  @on-ok="dealcancel" @on-cancel="dealcancel" :styles="{top: '20px'}">
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.trainSubject
                                    }
                                }, params.row.trainSubject)
                            ]);
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.trainOorganization
                                    }
                                }, params.row.trainOorganization)
                            ]);
        ...
        methods: {
            ...
            info(obj){
               /* this.$refs['formvali'].resetFields();
                this.trainingRecord = obj;
                this.modal1 = true;*/
                this.$router.push({path:'/viewTrainDetail',query: {obj:JSON.stringify(obj),employeeId:this.employeeId,employeeData:JSON.stringify(this.employeeData)}})
            },
            //修改框
            updateCheck(index) {
