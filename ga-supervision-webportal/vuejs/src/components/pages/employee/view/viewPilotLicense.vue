<template>
    <div style="width: 1280px; height:auto; margin-top: 30px; padding-top: 40px; background:white;">
        <div style="border: 1px solid #f0f0f0; margin-left: 40px; margin-right: 40px ">
                ...
                <div  v-if="license!==null">
                    <div  >
                        ...
                        <div  v-else-if="license.licenseclass=='运动驾驶员'" >
                            <div>
                                <FormItem label="是否是运动教员" style="display: inline-block;width: 550px" >
                                    <Select  v-model="license.issportspilotteacher"  placeholder="请选择">
                                        <Option value="1">是</Option>
                                        <Option value="0">否</Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="航空器类别等级" style="display: inline-block;width: 550px">
                            ...
                            <div>
                                <FormItem label="航空器级别等级" style="display: inline-block;width: 550px">
                        ...
                        <div  v-else-if="license.licenseclass=='多人制机组驾驶员'" >
                            <div>
                                <FormItem label="航空器类别等级" style="width: 550px;display: inline-block">
                            ...
                            <div>
                                <FormItem label="航空器型别等级" style="display: inline-block;width: 550px">
                        ...
                        <div  v-else >
                            <div>
                                <FormItem label="是否是飞行教员" style="display: inline-block;width: 550px" >
                            ...
                            <div v-if="license.ispilotteacher==1">
                                <div>
                                    <FormItem label="教员仪表等级" style="display: inline-block;width: 550px">
                                    ...
                                    <FormItem label="教员基础教员等级" style="display: inline-block;width: 550px">
                                ...
                                <div>
                                    <FormItem label="教员航空器型别" style="display: inline-block;width: 550px">
                            ...
                            <div v-if="license.ispilotteacher==0">
                                <div>
                                    <FormItem label="仪表等级" style="display: inline-block;width: 550px" >
                                    ...
                                    <FormItem label="驾驶员航空器类别" style="display: inline-block;width: 550px">
                                ...
                                <div>
                                    <FormItem label="驾驶员航空器型别" style="display: inline-block;width: 550px">
                                    ...
                                    <FormItem label="驾驶员航空器级别" style="display: inline-block;width: 550px">
            ...
            <Modal v-model="modal1" width="400" title="新增机型签注记录" @on-ok="submitCheckForm"
...
//                                    self.$Message.info('飞行执照信息保存成功');
                                    alert("执照信息保存成功！");
                                    if(this.type =='add'){
                                        self.$router.push({path: '/name2',query:{employeeId:self.employeeid,employee:this.employee,tab:'name2'}});
                                    }else if(this.type=='edit'){
                                        self.$http.httpGet('/eim/api/employee/'+self.employeeid,{
            ...
            submitInspectForm() {
                ...
                self.inspect_form.licenseId = self.qulification.id;
