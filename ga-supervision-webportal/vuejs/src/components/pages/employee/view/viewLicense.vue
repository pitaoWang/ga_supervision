    ...
    <div style="width: 1280px; height:auto; margin-top: 30px; padding-top: 40px; background:white;">
        <div style="border: 1px solid #f0f0f0; margin-left: 40px; margin-right: 40px ">
            <Form :label-width="205" :model="qualification" ref="formVali" style="margin-top: 20px">
                <div>
                    <div>
                        <FormItem label="执照类型" style="display: inline-block;width: 550px" prop="licensetype" :rules="{required: true,message: '请选择执照类型', trigger: 'change'}">
                    ...
                    <div>
                        ...
                        <FormItem label="颁发单位" style="display: inline-block;width: 550px" >
                    ...
                    <div>
                        <FormItem label="备注" style="display: inline-block;width: 550px" >
                            <Input v-model="qualification.remark" placeholder="请输入"></Input>
                        </FormItem>
                    </div>
                </div>
            </Form>
            ...
            <div  style="" v-show="checkrecordshow">
                <!--<span style="width:100%;display:inline-block;text-align:right;">
                    <Button type="primary" @click="add_dialog_show" icon="plus" style="width: 98px;height: 32px;margin:24px 20px 11px 0px;border: 1px dashed #2b82da;background: #DDF4FF;font-size: 14px;color: #2FA5FB;" size="small">增  加</Button>
                </span>-->
            ...
            <div style="margin-top: 20px" v-show="pilotlicenseinspectshow">
               <!-- <span style="width:100%;display:inline-block;text-align:right;">
                    <Button type="primary" @click="add_pilotlicenseinsepect" icon="plus" style="width: 98px;height: 32px;margin:24px 20px 11px 0px;border: 1px dashed #2b82da;background: #DDF4FF;font-size: 14px;color: #2FA5FB;" size="small">增  加</Button>
                </span>-->
                <div style="width: 1160px;margin-left: 20px">
                    <Table border :columns="columns8" :data="pilotLicenseInspect"></Table>
                </div>

                <!--<span style="width:100%;display:inline-block;text-align:right;">
                    <Button type="primary" @click="add_pilotlicensecheck_show" icon="plus" style="width: 98px;height: 32px;margin:24px 20px 11px 0px;border: 1px dashed #2b82da;background: #DDF4FF;font-size: 14px;color: #2FA5FB;" size="small">增  加</Button>
                </span>-->
                <div style="width: 1160px;margin-left: 20px">
                    <Table border :columns="columns9" :data="licenseChecks"></Table>
                </div>
            </div>
            ...
            <Modal v-model="modal1" width="400" title="新增执照签注记录" @on-ok="submitCheckForm"
                   @on-cancel="modal1 = false" :styles="{top: '20px'}">
            ...
            <Modal v-model="modal2" width="400" title="新增飞行执照检查记录" @on-ok="submitInspectForm"
                   @on-cancel="modal2 = false" :styles="{top: '20px'}">
                <Form :label-width="100" v-model="qualification" >
                    <div >
                        <Row>
                            <Col :md="23">
                                <FormItem label="检查时间" class="bottom5">
                                    <DatePicker v-model="inspect_form.checkDate" type="date" placeholder="选择日期"></DatePicker>
                                </FormItem>
                            </Col>
                            <Col :md="23">
                                <FormItem label="检查类型" class="bottom5">
                                    <Select v-model="inspect_form.checkType" placeholder="请选择" >
                                        <Option value="CP">CP</Option>
                                        <Option value="PC">PC</Option>
                                        <Option value="PC-PIC">PC-PIC</Option>
                                        <Option value="PC-CP">PC-CP</Option>
                            ...
                            <Col :md="23">
                                <FormItem label="航空器型号" class="bottom5">
                                    <Input v-model="inspect_form.aircraftModel" placeholder="请输入"/>
                                </FormItem>
                            </Col>
                            <Col :md="23">
                                <FormItem label="考试员签字" class="bottom5">
                                    <Input v-model="inspect_form.examSignature" placeholder="请输入"/>
                                </FormItem>
                            </Col>
                            <Col :md="23">
                                <FormItem label="备注" class="bottom5">
                                    <Input v-model="inspect_form.remark" placeholder="请输入"/>
                                </FormItem>
                            </Col>
                        </Row>
                    </div>
            ...
            <Modal v-model="modal3" width="400" title="机型签注记录" @on-ok="submitCheckForm"
                   @on-cancel="modal3 = false" :styles="{top: '20px'}">
                <Form :label-width="100" v-model="qualification" >
                    <div >
                        <Row>
                            <Col :md="23">
                                <FormItem label="机型编号" class="bottom5">
                                    <Input v-model="check_form.machineCode" placeholder="请输入"></Input>
                                </FormItem>
                            </Col>
                            <Col :md="23">
                                <FormItem label="机型签注类型" class="bottom5">
                                    <Input v-model="check_form.licenseCheckContent" placeholder="请输入"></Input>
                                </FormItem>
                            </Col>
                            <Col :md="23">
                                <FormItem label="签注人" class="bottom5">
                                    <Input v-model="check_form.checkMan" placeholder="请输入"></Input>
                                </FormItem>
                            </Col>
                        </Row>
                    </div>
    ...
    export default {
        ...
        data() {
            return {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.updateInspect(params.index)
                                        }
                                    }
                                }),
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.removeInspect(params.index);
                                        }
                                    }
                                })
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.updatePCheck(params.index)
                                        }
                                    }
                                }),
                                h('Button', {
                ...
                modal2:false,
                modal3:false,
               /* add_pilotlicensecheck_show:false,
                add_pilotlicenseinsepect:false,*/
                check_form: {},
                inspect_form:{},
                uploadList: [],
...
//                flightdispatcher:{}
        ...
        methods: {
            ...
            //检查
            add_pilotlicenseinsepect: function () {
                //清除信息
                //this.$refs[val].resetFields();
                this.inspectTemp={
                    id:'',
                    ...
                    this.inspect_form = this.inspectTemp;
                this.modal2 = true;
            },
            //机型签注
            add_pilotlicensecheck_show: function () {
                //清除信息
                //this.$refs[val].resetFields();
                this.temp={id:'',
                    licenseId:'',
            ...
            changeExt() {
                ...
                if (this.qualification.licensetype == "气象执照") {
                    ...
                    this.pilotlicenseinspectshow=false;
                }
                    ...
                    this.AiPartsRepairshow = false;
                    this.checkrecordshow = false;
                    this.pilotlicenseinspectshow=true;
                    this.aircraftRepairShow = false;
                    this.controllicenseshow = false;
            ...
            updateCheck(index) {
                ...
                this.temp.machineCode=this.licenseChecks[index].machineCode;
                this.temp.checkMan=this.licenseChecks[index].checkMan;
                this.check_form = this.temp;
            ...
            updateInspect(index){
                this.inspectTemp.id=this.pilotLicenseInspect[index].id;
                this.inspectTemp.licenseId=this.pilotLicenseInspect[index].licenseId;
                this.inspectTemp.checkDate=this.pilotLicenseInspect[index].checkDate;
                this.inspectTemp.checkType=this.pilotLicenseInspect[index].checkType;
                this.inspectTemp.aircraftModel=this.pilotLicenseInspect[index].aircraftModel;
                this.inspectTemp.examSignature=this.pilotLicenseInspect[index].examSignature;
                this.inspectTemp.remark=this.pilotLicenseInspect[index].remark;
                this.inspect_form = this.inspectTemp;
                this.pilotLicenseInspectIndex = index;
                this.modal2 = true;
            },
            ...
            removeInspect(index) {
                ...
                let url = "/eim/api";
                if (role == "pilot") {
                    let checkUrl = url + "/pilotLicenseInspect/" + this.pilotLicenseInspect[index].id;
                    self.$http.httpDelete(checkUrl, {}).then((res) => {
                        let result = res.data
                        if (result.resultCode == 200) {
                            self.pilotLicenseInspect.splice(index, 1);
                            self.$Message.info("删除成功，id=" + result.data);
                        }
                    });
                }
                    ...
                    if (valid) {
                        ...
                        if (this.qualification.licensetype == "气象执照") {
                            ...
                            request = {
                                ...
                                licenseChecks: self.licenseChecks,
                                pilotLicenseInspects:self.pilotLicenseInspect,
                            }
                        }
                        else if (this.qualification.licensetype == "管制执照") {
                            request = {
            ...
            submitInspectForm() {
                let self = this;
                let url = "/eim/api";
                let checkUrl = url + "/pilotLicenseInspect/save";
                let is_update = false;
                if (self.inspect_form.id) {
                    is_update = true;
                }
                self.$http.httpPost(checkUrl, self.inspect_form).then(function (res) {
                    let result = res.data;
                    if (result.resultCode == 200) {
                        self.inspect_form = {};
                        if (!is_update) {
                            self.pilotLicenseInspect.push(result.data);
                        }
                        else {
                            self.pilotLicenseInspect.splice(self.pilotLicenseInspectIndex, 1, self.inspectTemp);
                            self.pilotLicenseInspect[self.pilotLicenseInspectIndex] = result.data;
                        }
                    }
                }).catch(function (error) {
                    console.log(error);
            ...
            tosshangyiye() {
                if(this.$route.query.employeeData){
                    var employeeData=this.$route.query.employeeData;
                    var bir=this.$route.query.bir;
                    this.$router.push({path: '/viewEmployee',query:{user:employeeData,bir:bir}});
                }
               /* var employeeId=this.qualification.employeeId;
                let self = this;
                if(this.type == 'add'){
