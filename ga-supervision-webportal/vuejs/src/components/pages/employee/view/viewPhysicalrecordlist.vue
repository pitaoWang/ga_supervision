    ...
    <div style="width: 1280px; height: auto; background:white">
        <div  style="">
            ...
            <div class="bottom5" style="width: 1260px; margin-left: 10px">
                <Table  :columns="columns7" :data="formValidate.physicalRecords" @on-row-dblclick="info"></Table>
            </div>
        </div>
        <Modal v-model="add_dialog_show"  width="700" title="体检记录"
    ...
    export default {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.certificateNo
                                    }
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.certificateGrade
                                    }
                                }, params.row.certificateGrade)
                            ]);
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.issueUnit
                                    }
                                }, params.row.issueUnit)
                            ]);
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.certificateStartTime
                                    }
                                }, params.row.certificateStartTime)
                            ]);
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('span', {
                                    ...
                                    domProps: {
                                        title: params.row.certificateValidityTime
                                    }
                                }, params.row.certificateValidityTime)
                            ]);
        ...
        methods: {
            info(obj){
                ...
                this.$router.push({path:'/viewPhysicalDetail',query: {obj:JSON.stringify(obj),employeeId:this.employeeId,employeeData:JSON.stringify(this.employeeData)}})
            },
            modalshow(val){
            ...
            getPhysicalrecords(employeeId) {
                ...
                self.$http.httpGet('/eim/api/physical/serach/getbyemployeeids', {
...
//                    });
            ...
            removeCheck(index) {
                let self = this;
                let url = "/eim/api";
                let checkUrl = url + "/physical/delete/" + this.formValidate.physicalRecords[index].id;
