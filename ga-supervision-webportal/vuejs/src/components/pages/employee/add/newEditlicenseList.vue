...
//                    });
            ...
            updateCheck(index) {
                ...
                if(this.PersonQulificationInfolist[index].licensetype=='飞行执照') {
                    this.$router.push({
                        path: '/for_liceninfo',
                        query: {licenseId: this.PersonQulificationInfolist[index].id,employee:this.employee}
                    });
                }
                else{
                    this.$router.push({
                        path: '/for_addlicen',
                        query: {licenseId: this.PersonQulificationInfolist[index].id,licensetype:this.PersonQulificationInfolist[index].licensetype,employee:this.employee}
                    });
                }
            },
